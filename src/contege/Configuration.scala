...
class PathTesterConfig (cut: String,
						val targetCutMethod: String,
						val targetMethodParameters: Set[List[Option[TypedParameter]]],
						seed: Int,
						val maxTests: Int,
						workingDir: File) extends Config(cut, seed, 0, None, workingDir, false) {
}