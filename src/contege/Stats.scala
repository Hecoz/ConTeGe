...
class Stats {
	...
	def print = {
		println("\n=== Statistics:  ===")
		println("Executed sequences: "+executedSequences.get)
		println("   Failed         : "+failedSequenceExecutions.get)
		println("Concurrent runs: "+concurrentRuns.get)
		println("   Succeeded   : "+succeededConcRuns.get)
		println("   Failed      : "+failedConcRuns.get)
		println("Sequential interleavings: "+sequentialInterleavings.get)
		println("------------")
